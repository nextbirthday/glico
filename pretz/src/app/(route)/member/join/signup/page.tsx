...
const Signup = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
          const response = await axios.post(process.env.NEXT_PUBLIC_SPRING_IP + 'member/signup', submitData)
    ...
    <>
      <div className="signup__body">
        <div className="signup__logo">
          <Link href="/">
            {/* public directory 안에 있는 파일은 /public 생략하고 접근 가능 */}
            <img src='/svgs/nexon.svg'  alt="" className="signup__image" />
          </Link>
        </div>
